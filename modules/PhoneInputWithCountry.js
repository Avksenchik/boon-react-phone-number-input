  ...
  _createClass(PhoneNumberInput_, [{
    ...
    value: function render() {
      var _this$props5 = this.props,
          ...
          inputClass = _this$props5.inputClass,
      ...
      return React.createElement("div", {
        style: style,
        className: classNames(divClass, (clearDefDivClass) ? '' : 'PhoneInput', {
      ...
      })),React.createElement('div', {id: 'country-code'}, countryCode),
      React.createElement(InputComponent, _extends({
        ...
        className: classNames(inputClass, (clearDefInpClass) ? '' : 'PhoneInputInput', numberInputProps && numberInputProps.className, rest.className)
      })));
    }
  }], [{
